...
//dcr #if !defined(__CYGWIN__) && defined(WIN32)
//dcr # define TSRM_WIN32
//dcr # include "Zend/zend_config.w32.h"
//dcr #else
//dcr # include "main/php_config.h"
//dcr #endif

#include "../main/php_stdint.h" //dcr old is: "/main/php_stdint.h"
